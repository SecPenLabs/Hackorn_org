...
const WhyJoin = () => {
  return (
    <>
      <section className="relative bg-neutral-950 w-full overflow-x-hidden py-24 px-4 flex flex-col items-center justify-center antialiased font-sans">
        {/* Main Title Section */}
        <div className="max-w-2xl mx-auto text-center relative z-10">
          <h1 className="text-5xl md:text-7xl bg-clip-text text-transparent bg-gradient-to-b from-neutral-100 to-neutral-500 font-bold mb-12 font-mono">
            WHY JOIN US?
          </h1>
        ...
        <div className="max-w-4xl mx-auto text-center mt-20 z-10 relative">
          <h2 className="text-3xl md:text-4xl font-bold text-[#4AF626] mb-4 font-mono">
            Hack. Learn. Lead.
          </h2>
